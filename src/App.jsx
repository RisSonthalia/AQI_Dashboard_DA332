...
function App() {
  ...
  // Functions to calculate individual pollutant AQI values (simplified versions)
  ...
  useEffect(() => {
    if (searchTerm) {
      ...
      console.log("Search term:", searchTerm, "Found stations:", filtered.length);
