        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow">
            ...
            <div 
              ...
              style={{ color: getAqiColor(summaryData.avg_aqi) }}
            >
              {Math.round(summaryData.avg_aqi)}
            </div>
            <div className="text-sm text-gray-500 dark:text-gray-400">
              {getAqiCategory(summaryData.avg_aqi)}
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">{summaryData.station_count}</span>
              </div>
              <div className="flex justify-between">
                <span>Min AQI:</span>
                <span className="font-semibold">{Math.round(summaryData.min_aqi)}</span>
              </div>
              <div className="flex justify-between">
                <span>Max AQI:</span>
                <span className="font-semibold">{Math.round(summaryData.max_aqi)}</span>
              </div>
            </div>
          </div>
